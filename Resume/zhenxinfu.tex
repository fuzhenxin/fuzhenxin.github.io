...
\begin{rSection}{其他}
    ...
    \textbf{奖励}: [1] 北京大学``赛帕斯''杯程序设计竞赛, 三等奖, 2016. [2] 优秀科研奖，北京大学, 2019. [3] 三好学生标兵, 2020.\\
    \textbf{GitHub}: 文本风格迁移论文列表。GitHub中Star数850. \\链接: \url{https://github.com/fuzhenxin/Style-Transfer-in-Text}
\end{rSection}
